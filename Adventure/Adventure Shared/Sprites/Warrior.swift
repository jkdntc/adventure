...
final class Warrior: HeroCharacter, SharedAssetProvider {
    ...
    class func loadSharedAssets() {
        ...
        idleAnimationFrames = loadFramesFromAtlasWithName(atlasName: "Warrior_Idle")
        walkAnimationFrames = loadFramesFromAtlasWithName(atlasName: "Warrior_Walk")
        attackAnimationFrames = loadFramesFromAtlasWithName(atlasName: "Warrior_Attack")
